...
# Bug 1: Select dropdown doesn't scroll with rest of the page (fixed css property change)
...
# Bug 2: Approve checkbox not working (fixed order of element)
...
# Bug 3: Cannot select _All Employees_ after selecting an employee (fixed added conditional to src/app.tsx in line 67)
...
# Bug 4: Clicking on View More button not showing correct data (fixed by concating response to prev)
...
# Bug 5: Employees filter not available during loading more data (fixed by moving setIsLodaing line above the paginatedTransactionsUtils function.)
